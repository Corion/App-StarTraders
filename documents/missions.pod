...
=head2 Jade Empire Twist ("Everything you know is wrong, but you swallowed it, hook, line and sinker")
    ...
    How will the Deus Ex Machina work to resolve the twist?
...
a big tournament, and on a "lucky streak" when the countdown before
...
locations at certain times. Be there and gather the riches.
